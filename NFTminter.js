...
function listNFTs () {
    for (let i = 0; i < NFTContainer.length; i++) {
        console.log("\n\n_____________________ chota bheem  _________________________\n\n" );
...
mintNFT("bheem", "laddu", "Rare", 100, 50, 100, 1);
mintNFT("chutki", "belan", "Common", 50, 50, 50, 1);
mintNFT("kaliya", "weight", "Common", 50, 50, 50, 1);
mintNFT("raju", "small height", "Common", 50, 50, 50, 1);
listNFTs();
getTotalSupply();
